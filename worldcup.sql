...
ALTER SEQUENCE public.teams_name_seq OWNED BY public.teams.team_id;
...
ALTER TABLE ONLY public.teams ALTER COLUMN team_id SET DEFAULT nextval('public.teams_name_seq'::regclass);
...
SELECT pg_catalog.setval('public.teams_name_seq', 280, true);
